...
import './primary_view_model.dart';
class Data {
 int _rowNum;
  int _id;
  String _unitRef;
  ...
  set amenities(List<Amenities> amenities) => _amenities = amenities;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['amenities'] != null) {
      _amenities = new List<Amenities>();
      json['amenities'].forEach((v) {
        _amenities.add(new Amenities.fromJson(v));
      });
    }
